...
# print("=====RS3Mamba======")
# rs3mamba = RS3Mamba(num_classes=6)
# # rs3mamba = load_pretrained_ckpt(rs3mamba)
# calculate(rs3mamba)

# print("=====MAResUNet======")
# maresunet = MAResUNet(num_channels=3, num_classes=6)
# calculate(maresunet)

# print("=====MANet======")
# manet = MANet(num_channels=3, num_classes=6)
# calculate(manet)

# print("=====DANet======")
# danet = DAnet(num_classes=6)
# calculate(danet)
