...
from geoseg.models.networks.TMF import TMFblock
...
class Local_SS2D(nn.Module):
    def __init__(self, dim, dropout=0., d_state=16):
        super().__init__()
...
class VSSBlock(nn.Module):
    def __init__(
        ...
        **kwargs,
        ...
        self.local = Local_SS2D(dim=d_model, dropout=attn_drop_rate, d_state=d_state, **kwargs)
...
class VSSM(nn.Module):
    def __init__(self, patch_size=4, in_chans=1, num_classes=4, depths=[2, 2, 9, 2], 
        ...
        base_dims = 64
        state_dict = torch.load('/home/phj/CM-UNet/weight/pytorch_model.bin')
